...
def autoencoder(input_dims, hidden_layers, latent_dims):
    ...
    for nodes in reversed(hidden_layers):
        decoder_output = keras.layers.Dense(nodes, activation='relu')(decoder_output)
    ...
    auto = keras.models.Model(input_layer, decoder(encoder(input_layer)), name="autoencoder")
