...
class BidirectionalCell:
    """ A python function that represents a bidirectional cell of an RNN """
    ...
    def backward(self, h_next, x_t):
        """ A python function that calculates the hidden state
    ...
    def output(self, H):
        """ A python function that calculates all outputs for the RNN """
